...
import { getCommentById } from "@/src/store/userActions";
...
const BookDetail: React.FC = () => {
    ...
    useEffect(() => {
        console.log('id', id);
        dispatch(getCommentById(id as string));
    ...
    const top5comments = getSortedComments().slice(0, 5);

    const handlePress = () => {
        router.push({ pathname: "/home/book/reviewDetail/[id]", params: { id: book.id } });
    };
    ...
    return (
        <ScrollView contentContainerStyle={styles.container}>
            <View style={styles.container}>
                ...
                <WantToReadButton isBookMarked={bookMarked?.some(book => book.id === id)} id={id as string} />
